...
//      * 开始时间轴
//      * */
//     start(frameFunc,_wxCanvas){
//         this._currentTimeStep = 0;
//         TimeLine.main._isPause = false;
//         if(frameFunc && typeof(frameFunc) === "function")
//         {
//             this.frameFunc = frameFunc;
//           this._aniID = _wxCanvas.requestAnimationFrame(TimeLine.main.updateTimeLine)
//         }
//     }
...
//      * 帧频函数
//      * */
//   updateTimeLine(timeStep, _wxCanvas){
...
//             //没停止或者暂停,就继续播放下一帧
//           TimeLine.main._aniID = _wxCanvas.requestAnimationFrame(TimeLine.main.updateTimeLine)
//         }else{
//             //停止动画
//           _wxCanvas.cancelAnimationFrame(TimeLine.main._aniID);
//         }
//     }
